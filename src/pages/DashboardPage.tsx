            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={6}>
                <>
                  ...
                  {/* Mostrar Monto Sistema - SIEMPRE */}
                  <Typography sx={{ mb: 1 }}>
                    <strong>Monto Sistema:</strong>{' '}
                    <Box component="span" sx={{ color: 'info.main', fontWeight: 600 }}>
                      ₡{caja.montoSistema ? Number(caja.montoSistema).toLocaleString('es-CR') : '0'}
                    </Box>
                  </Typography>

                  {/* Mostrar Total Ventas - SIEMPRE */}
                  <Typography sx={{ mb: 1 }}>
                    ...
                    >
                      ₡{caja.totalVentas ? Number(caja.totalVentas).toLocaleString('es-CR') : '0'}
                    </Box>
                  </Typography>
                  ...
                  <Typography sx={{ mb: 2 }}>
                    ...
                    <Box
                      ...
                      sx={{ 
                        color: (() => {
                          const montoSis = Number(caja.montoSistema || 0);
                          const montoIni = Number(caja.montoInicial || 0);
                          return (montoSis - montoIni) >= 0 ? 'success.main' : 'error.main';
                        })(),
                        fontWeight: 600 
                      }}
                    >
                      ₡{(() => {
                        const montoSis = Number(caja.montoSistema || 0);
                        const montoIni = Number(caja.montoInicial || 0);
                        const diferencia = montoSis - montoIni;
                ...
                >
                    ...
                    >
                      {{
                        ...
                        sec.label === 'Administracion  General' 
                          ? 'Registra y controla pagos a proveedores, planillas y manejo de empleados.'
                          : ''
                      )}
                    </Typography>
